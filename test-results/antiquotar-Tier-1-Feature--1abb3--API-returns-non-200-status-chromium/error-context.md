...
- Name: antiquotar.spec.ts >> Tier 1: Feature Coverage >> 18. Run Check logs warning when LS Gateway API returns non-200 status
- Location: tests\antiquotar.spec.ts:379:3
...
Expected: "LS endpoint returned error status: 500"
Received: "Added 1 cookie pair(s) for a.com."
Timeout:  5000ms

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for locator('.log-list .log-item p').first()
    14 × locator resolved to <p>Added 1 cookie pair(s) for a.com.</p>
       - unexpected value "Added 1 cookie pair(s) for a.com."

```

```yaml
- paragraph: Added 1 cookie pair(s) for a.com.
```
