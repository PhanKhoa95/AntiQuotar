...
You are reviewer_swapping_4. Your working directory is y:\AntiQuotar\.agents\reviewer_swapping_4.
...
Write your review report to `y:\AntiQuotar\.agents\reviewer_swapping_4\review.md` and send a handoff message to the main agent (id: 23ef1eb1-8755-4a8b-ade2-a4e16c084540) with the path to your report.
